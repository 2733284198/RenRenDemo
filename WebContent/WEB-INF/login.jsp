...
<html class="nx-main980">
	...
	<div class="pic"><img src="./login_files/person.jpg" id="personhead" width="100" height="100" style="margin-top: 0px;"></div>
	</div>
...
<form method="post" id="loginForm" class="login-form" action="/RenRenDemo/tologin.action">
<dl class="top clearfix">
<dd style="border-color: rgb(173, 182, 201);">
<input type="text" name="email" class="input-text" id="email" tabindex="1" value="${email}" style="color: rgb(136, 136, 136);">
</dd>
</dl>
...
<div class="regnow">
<input type="submit" onclick="" id="regnow" class="input-button login-btn regbutton" value="注册" tabindex="6">
</div>
</form>
...
<div class="Third-partyi-login">
	<a title="微信" class="login-item weixin" href="http://www.renren.com/api/jump?src=wx" id="login_weixin" stats="loginPage_weixin_link"></a>
	 ...
	 <a href="/RenRenDemo/adminlogin.action" title="管理员"><img src="img/adminicon.jpg" style="padding-left: 64px;padding-top: 14px;"></a>
</div>
</div>
